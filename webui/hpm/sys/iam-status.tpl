    ...
    <form id="hp-mgr-sys-iam" action="#">
      <table width="100%" class="table table-hover hp-sys-table">
        ...
        <tr>
          ...
          <td>{[? it.instance_registered]}{[=it.instance_registered.version]}{[?]}</td>
        </tr>

        <tr>
          <td>App ID</td>
          <td>{[=it.instance_self.id]}</td>
          <td>{[? it.instance_registered]}{[=it.instance_registered.id]}{[?]}</td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input
              ...
              value="{[=it.instance_self.name]}"
            />
          </td>
          <td>{[? it.instance_registered]}{[=it.instance_registered.name]}{[?]}</td>
        </tr>
        ...
        <tr>
          ...
          <td>{[? it.instance_registered]}{[=it.instance_registered.url]}{[?]}</td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <table class="table">
              ...
              <tbody>
                {[~it.instance_self.permissions :v]}
                <tr>
                  <td>
          ...
          <td>
            ...
            <table class="table">
              ...
              <tbody>
                {[~it.instance_registered.permissions :v]}
                <tr>
                  <td>
                    <p><strong>{[=v.summary]}</strong></p>
                    <p>{[=v.permission]}</p>

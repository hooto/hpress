...
<form id="l9rproj-newform" action="#">
  <table width="100%" class="table table-condensed">
    <tr class="bordernil">
      <td width="180px">
        <strong>{%Unique Project Name%}</strong>
      ...
      <td>
        ...
        <div class="help-ctn">
          ...
          <div class="">
            {%Must consist of letters, numbers, `_` or `-`, and begin with a
            letter%}
          </div>
        </div>
      </td>
    ...
    <tr>
      <td>
        <strong>{%Group by Application%}</strong>
        <span style="color: red">*</span>
      </td>
      <td class="r0330s">
        {[~it._grpappd :v]}

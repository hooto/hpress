...
<table class="lc-editor-set-form" width="100%">
    ...
    <td>
      <div class="input-prepend">
        ...
        <input
          ...
          type="text"
          value="4"
          onchange="_lc_editorset_save('<span></span>Tab width<span></span>')"
        />
      </div>
      <label class="checkbox">
        <input
          ...
          id="tabs2spaces"
          value="1"
          onchange="_lc_editorset_save('<span></span>Insert spaces instead of tabs<span></span>')"
        />
    ...
    <td>
      <label class="checkbox">
        <input
          ...
          id="smartIndent"
          value="1"
          onchange="_lc_editorset_save('<span></span>Enable automatic indentation<span></span>')"
        />
    ...
    <td>
      <label class="checkbox">
        <input
          ...
          id="lineWrapping"
          value="1"
          onchange="_lc_editorset_save('<span></span>Enable text wrapping<span></span>')"
        />
    ...
    <td>
      <label class="checkbox">
        <input
          ...
          id="codeFolding"
          value="1"
          onchange="_lc_editorset_save('<span></span>Enable Code Folding<span></span>')"
        />
  ...
  <tr class="l">
    ...
    <td>
      <label
        ><span></span>Press `shift + space` to activate autocompletion<span
        ></span
      ></label>
      <p class="alert alert-info">
        <span></span>editor-autocomplete-desc<span></span>
      </p>
    </td>
  </tr>

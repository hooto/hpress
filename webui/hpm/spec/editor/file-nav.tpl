    ...
    <li class="lfnm-item">
      ...
      <ul class="lfnm-item-submenu">
        <li>
          ...
          >
            <img
              src="/lesscreator/~/lesscreator/img/page_white_add.png"
              class="h5c_icon"
            />
            New File
          </a>
        ...
        <li>
          <a
            href="#proj/fs/file-new-dir"
            onclick="l9rProjFs.FileNew('dir', null, '')"
          >
            <img
              src="/lesscreator/~/lesscreator/img/folder_add.png"
              class="h5c_icon"
            />
            New Folder
          </a>
        ...
        <li>
          <a href="#proj/fs/file-upl" onclick="l9rProjFs.FileUpload(null)">
            <img
              src="/lesscreator/~/lesscreator/img/page_white_get.png"
              class="h5c_icon"
            />
            Upload
          </a>
...
<div id="lcx-filenav-tree-tpl" class="hide">
  ...
  >
    <img
      src="/lesscreator/~/lesscreator/img/{[=v.ico]}.png"
      align="absmiddle"
    />
...
<div id="lcbind-fsnav-rcm" class="hide">
  ...
  <div class="lcbind-fsrcm-item" lc-fsnav="rename">
    <div class="rcico">
      <img
        src="/lesscreator/~/lesscreator/img/page_white_copy.png"
        align="absmiddle"
      />
    </div>
...
<div id="lcbind-fstpl-filerename" class="hide">
  ...
  >
    <div class="input-prepend" style="margin-left: 2px">
      <span class="add-on">
        <img
          src="/lesscreator/~/lesscreator/img/folder_edit.png"
          class="h5c_icon"
        />
      </span>
      <input
  ...
  <div id="{[=it.reqid]}">
    ...
    <div class="input-prepend">
      ...
      <input
        ...
        value="{[=it.path]}"
      />
      <button class="btn hide" type="button" onclick="_fs_upl_chgdir()">
        Change directory
      </button>
    </div>

<head>
  ...
  <title>
    {{if .__html_head_title__}}{{.__html_head_title__}} | {{end}}{{SysConfig
    `frontend_html_head_subtitle`}}
  </title>
  <link
    rel="stylesheet"
  ...
  <link
    rel="shortcut icon"
    type="image/x-icon"
    href="{{SysConfig `frontend_header_site_icon_url`}}?v={{.sys_version_sign}}"
  />
  {{else}}
  <link
    rel="shortcut icon"
  ...
  <script src="{{HttpSrvBasePath `hp/lynkui/~/bs/v5/js/bootstrap.js`}}?v={{.sys_version_sign}}"></script>

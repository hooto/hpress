...
.PHONY: all build_frontend build_backend build cli clipper release run run-be run-fe check install-deps version clean
...
cli:
	@echo "Building cli..."
	CGO_ENABLED=0 go build -o bin/hpress cmd/cli/*.go

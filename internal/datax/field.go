...
func markdownCommon(v []byte, opts *hpapi.NodeFieldTextRenderOptions) []byte {
...
func fieldValue(fields []*hpapi.NodeField, colname string) (string, map[string]string) {
...
func FieldString(fields []*hpapi.NodeField, colname string) string {
...
func FieldSubString(fields []*hpapi.NodeField, colname string, length int) string {
...
func FieldDebug(fields []*hpapi.NodeField, colname string, length int) template.HTML {
...
func FieldHtml(fields []*hpapi.NodeField, colname string) template.HTML {
...
func FieldSubHtml(fields []*hpapi.NodeField, colname string, length int) template.HTML {

	var field *hpapi.NodeField
...
func FieldHtmlSubPrint(nodeEntry hpapi.Node, colname string, length int, lang string) template.HTML {
...
func FieldStringPrint(nodeEntry hpapi.Node, colname, lang string) string {
...
func FieldHtmlPrint(nodeEntry hpapi.Node, colname, lang string) template.HTML {
	...
	opts := &hpapi.NodeFieldTextRenderOptions{}
